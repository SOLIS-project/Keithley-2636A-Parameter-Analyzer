...
srdp_stim_width_entry.insert(0, "100")
...
# Wrap run_stdp_characterization to use correct parameters
original_run_stdp = run_stdp_characterization
def run_stdp_characterization():
    # Temporarily update parameter references for STDP
    global stim_level_entry, stim_width_entry, stim_period_entry
    old_stim_level = stim_level_entry
    old_stim_width = stim_width_entry
    old_stim_period = stim_period_entry
    
    stim_level_entry = stdp_pre_level_entry
    stim_width_entry = stdp_pulse_width_entry
    stim_period_entry = stdp_pair_period_entry
    ...
    try:
        ...
        stim_level_entry = old_stim_level
        stim_width_entry = old_stim_width
        stim_period_entry = old_stim_period
